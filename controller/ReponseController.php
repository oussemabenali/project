...
class ReponseController extends AbstractController
{
    ...
    /**
     * @Route("/frontreponse", name="app_reponse_indexfront", methods={"GET"})
     */
    public function frontreponse(ReponseRepository $reponseRepository): Response
    {
        return $this->render('reponseF/reponseFront.html.twig', [
            'reponses' => $reponseRepository->findAll(),
        ]);
    }
